<template>
 ...
 <p class="highlight">The family and friends of Baron David Ward wish to thank everyone who has contacted them, as well as to all those who have shared kindness, memories, tributes and heartfelt words of support in various online forums. Thank you.</p>      
      <CoolLightBox 
        :items="images" 
        :index="index"
        @close="index = null">
